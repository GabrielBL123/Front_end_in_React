  ...
  return (
    <div className="w-full max-w-5xl bg-white p-8 md:p-14 rounded-3xl shadow-2xl my-8 mx-auto">
      ...
      <div className="flex justify-between items-center mb-10 border-b-2 border-green-100 pb-5">
        <div>
          ...
          <p className="text-gray-500 mt-1 text-base">
            Cadastre ou remova setores vinculando-os ao CNPJ da empresa
            correspondente.
          </p>
        </div>
        <button
      ...
      <form
        ...
        className="bg-gray-50 p-6 md:p-8 rounded-2xl border border-gray-200 mb-12 flex flex-col gap-6 shadow-inner"
      >
        <h2 className="text-xl font-bold text-gray-800 mb-2 border-l-4 border-green-600 pl-3">
          Novo Cadastro
        </h2>
              ...
              >
                ...
                {s.empresaCnpj && (
                  <div className="pt-3 border-t border-gray-100 flex justify-between items-center text-xs text-gray-500">
                    ...
                    <span className="bg-gray-100 px-2 py-1 rounded font-mono text-gray-600">
                      {s.empresaCnpj}
                    </span>
                  </div>
                )}
